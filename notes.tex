...
\label{sec:org65558eb}

In this section, 

\subsection{Literature review}
\label{sec:orgfbfc19c}
...
\label{sec:org7e5ca89}

Following \cite{Bishop_2017,Moll_2018}, we can expand the Quantum Volume general equation (\(\tilde{V}_Q\)) with the other definitions and maximize for the biggest possible \(n\). 
